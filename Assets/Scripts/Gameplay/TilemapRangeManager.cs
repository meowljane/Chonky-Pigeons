...
namespace PigeonGame.Gameplay
{
    /// <summary>
    /// 타일맵 기반 맵 범위 관리 시스템
    /// 각 타일맵 GameObject에 MapArea, TerrainArea, PlayerMovementArea 컴포넌트를 부착하여 타입 지정
    /// </summary>
    public class TilemapRangeManager : MonoBehaviour
    {
        ...
        private void InitializeTilemaps()
        {
            ...
            Debug.Log($"TilemapRangeManager: {tilemapToMapArea.Count}개의 맵 타일맵, {tilemapToTerrainArea.Count}개의 지형 타일맵, {playerMovementTilemaps.Count}개의 플레이어 이동 타일맵을 로드했습니다.");
        }
